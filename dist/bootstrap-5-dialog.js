...
window.Dialogs = {
  init: function init() {
    ...
    document.getElementById('ED71E448_64C1_AF42_4276_E41BAA4C8E0A').addEventListener('click', function () {
      _this._trigger(0, true);
    }, false);
    document.getElementById('DF61835E_6EAA_ABC2_24B6_EB39EFFE46CB').addEventListener('click', function () {
      _this._trigger(1, false);
    }, false);
    document.getElementById('A41CEA51_4413_16BC_9E4C_977D3A350062').addEventListener('click', function () {
      _this._trigger(1, true);
    }, false);
    document.getElementById('C77F3CCA_CD38_CF08_F6F8_72E81546F8F5').addEventListener('click', function () {
      _this._trigger(2, false);
    }, false);
    document.getElementById('A43989C8_BCC4_E4E6_45B5_F7865F5D3891').addEventListener('click', function () {
      _this._trigger(2, true);
    }, false);
    document.getElementById('BE21C0E4_17C8_81C1_23C4_943DC0497612').addEventListener('keypress', function (e) {
      if (e.keyCode === 13) _this._trigger(2, true);
    }, false);
  },
  okayLabel: 'Okay',
  cancelLabel: 'Cancel',
  ...
  prompt: function prompt(message, value, settings) {
    ...
    document.getElementById('BE21C0E4_17C8_81C1_23C4_943DC0497612').focus();
  }
};
